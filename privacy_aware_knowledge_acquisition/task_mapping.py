task_dict = {'uci_credit_card':'cls','mice_protein':'cls','activity':'cls', 'airfoil': 'reg', 'amazon_employee': 'cls', 'ap_omentum_ovary':
...
sens_task_dict = {'uci_credit_card':'cls','mice_protein':'reg', 'activity':'reg', 'airfoil': 'reg', 'amazon_employee': 'cls', 'ap_omentum_ovary':'reg', 
...
sens = {'airfoil': 'reg', 'amazon_employee': 'cls', 'ap_omentum_ovary':
    'cls', 'bike_share': 'reg', 'german_credit': 'cls', 'higgs': 'cls',
             'housing_boston': 'reg', 'ionosphere': 'cls', 'lymphography': 'cls',
             'messidor_features': 'cls', 'openml_620': 'reg', 'pima_indian': 'cls',
             'spam_base': 'cls', 'spectf': 'cls', 'svmguide3': 'cls',
